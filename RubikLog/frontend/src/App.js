...
const customAnimationClasses = {
    // Remove the rotation from button animation
    button: "relative inline-flex items-center justify-center p-2 overflow-hidden rounded-lg transition-colors duration-300 hover:text-white group",
            ...
            <div className="max-w-4xl mx-auto relative px-4 sm:px-6 lg:px-8">
                ...
                <div className="absolute top-4 right-4">
                    <button
                        ...
                        className={`${customAnimationClasses.button} ${darkMode ? 'hover:bg-yellow-400' : 'hover:bg-gray-900'
                            }`}
                    >
                        {darkMode ? (
                            <svg className="w-6 h-6 text-yellow-400 group-hover:text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
